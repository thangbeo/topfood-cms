<template>
  ...
  >
    ...
    />
    <g id="Group_166" data-name="Group 166" transform="translate(7.036 7.971)">
      <g id="Polygon_11" data-name="Polygon 11" fill="none" stroke-linejoin="round">
        <path
      ...
      <g id="Group_165" data-name="Group 165" transform="translate(6.964 4.415)">
        <path
          id="Path_70"
          data-name="Path 70"
